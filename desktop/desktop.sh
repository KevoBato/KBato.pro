...
# Step 0: Install main dependencies using the provided command
...
# Step 6: Create the BatoDesktop script to launch Google Chrome
echo "Creating BatoDesktop script in Ports..."
...
# Step 9: Download the BatoDesktop logo for the menu
echo "Downloading BatoDesktop logo..."
curl -L -o /userdata/roms/ports/images/batodesktop-logo.png https://github.com/DTJW92/batocera-unofficial-addons/raw/main/batodesktop/extra/logo.png
echo "Adding logo to BatoDesktop entry in gamelist.xml..."
xmlstarlet ed -s "/gameList" -t elem -n "game" -v "" \
  -s "/gameList/game[last()]" -t elem -n "path" -v "./BatoDesktop.sh" \
  -s "/gameList/game[last()]" -t elem -n "name" -v "BatoDesktop" \
  -s "/gameList/game[last()]" -t elem -n "image" -v "./images/batodesktop-logo.png" \
